...
theme.screen_selection_color = hcolor.change(theme.common.primary, {
    alpha = 0.20 --[[ 0x33 ]],
})
...
theme.mebox = {
    ...
    item_styles = {
        ...
        selected = {
            normal = setmetatable(
                { border_width = 0 },
                { __index = theme.capsule.styles.palette[theme.color_names.common.primary] }
            ),
            active = setmetatable(
                { border_width = 0 },
                { __index = theme.capsule.styles.palette[theme.color_names.common.secondary] }
            ),
...
theme.taglist.item = {
    ...
    urgent = setmetatable({}, { __index = theme.capsule.styles.urgent }),
    empty = setmetatable({}, { __index = theme.capsule.styles.disabled }),
...
theme.clientlist.item = {
    normal = setmetatable({}, { __index = theme.capsule.styles.normal }),
    active = setmetatable({}, { __index = theme.capsule.styles.selected }),
    urgent = setmetatable({}, { __index = theme.capsule.styles.urgent }),
    minimized = setmetatable({}, { __index = theme.capsule.styles.disabled }),
}

----------------------------------------------------------------------------------------------------

local client_border_width = dpi(3)
local client_border_radius = dpi(0)
